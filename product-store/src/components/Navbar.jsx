...
//           <Link to="/" className="text-2xl font-bold text-purple-600 dark:text-indigo-400">
//             ProductStore
//           </Link>
          
//           <div className="flex items-center gap-4">
//             <Link to="/cart" className="relative">
//               <ShoppingCart className="w-6 h-6 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-indigo-400 transition" />
//               {totalItems > 0 && (
...
//             <Link to="/settings">
//               <Settings className="w-6 h-6 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-indigo-400 transition" />
//             </Link>
//           </div>
//         </div>
//       </div>
