...
//     // DummyJSON returns { products: [...] } so we extract the array
...
//     }
//     const data = await response.json()
//     // Transform to match expected shape (same as FakeStore)
//     return {
//       id: data.id,
//       title: data.title,
//       price: data.price,
...
//       image: data.thumbnail, // DummyJSON uses thumbnail
//     }
//   } catch (error) {
//     console.error('API Error:', error)
//     throw new Error('Failed to fetch product details')
